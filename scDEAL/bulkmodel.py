...
def run_main(args):
    ...
    with torch.no_grad():
        ...
        # print('Macro F1 : ', round(report_dict['macro avg']['f1-score'], 3))
        # print('Weighted F1 : ', round(report_dict['weighted avg']['f1-score'], 3))
        print(preditor_path)
        print('F1: ', round(f1score, 3), '| AUC : ', round(auroc_score, 3))
